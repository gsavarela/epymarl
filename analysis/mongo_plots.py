...
def main3(
    ...
    # QUERY_IDS = [91, 98, 104] # 'hp_grp_15' < 10.14
    # QUERY_IDS = [106, 113, 119] # 'hp_grp_16'
    # QUERY_IDS = [107, 112, 125] # 'hp_grp_17'
    ...
    for query in QUERIES:
        ...
        for experiment in experiments:
            ...
            print(f"algoname: {algoname} source: {taskname} n_points:{len(ts.index)}")

            steps[key].append(ts.index)
            results[key].append(ts.values)
            sample_size += 1
