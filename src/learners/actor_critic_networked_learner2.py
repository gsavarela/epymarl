...
class ActorCriticNetworkedLearner2:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        for _i, _opt, _params, _target, _mask in zip(
            ...
            self.critic_optimisers,
            self.critic_params,
            th.tensor_split(target_vals, self.n_agents, dim=2),
            th.tensor_split(mask, self.n_agents, dim=2),
        ):
    ...
    def train_critic_sequential(self, critic, target_vals, batch, rewards, mask):
